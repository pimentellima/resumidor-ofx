...
const testStatements = [
    {
        ...
        date: '2024-04-01',
        description:
            'Transferência Recebida - 44.242.341/0001-49 - NU PAGAMENTOS - IP (0260) Agência: 1 Conta: 25262378-2',
    ...
    },
    {
        ...
        date: '2024-04-01',
        description:
            'Transferência enviada pelo Pix - NU PAGAMENTOS - IP (0260) Agência: 1 Conta: 11183217-2',
...
export default function StatementView() {
    ...
    return (
        <div className="h-screen flex flex-col py-3 px-6">
            <div className="flex flex-col mb-2">
                <Label htmlFor="file" className="mt-2 font-semibold mb-2 pl-4">
                    Selecione o arquivo .ofx do extrato bancário para importar
                </Label>
            ...
            <div className="grid grid-cols-2 gap-2 h-full">
                <StatementsTable statements={statements as Statement[]} />
                <Chat />
            </div>
        </div>
    )
    ...
    return (
        <div className="border rounded-md flex flex-col justify-between p-2">
            ...
            <div className="flex justify-center items-center">
                ...
                />
                <Button size={'icon'} className="mx-2 h-full w-16">
                    <SendHorizonal className="h-10 text-primary-foreground" />
                </Button>
            </div>
        </div>
    )
